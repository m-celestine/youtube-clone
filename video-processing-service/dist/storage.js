...
const storage_1 = require("@google-cloud/storage"); // Tool to connect to Google Cloud Storage
const fs_1 = __importDefault(require("fs")); // Tool to work with files on this computer
const fluent_ffmpeg_1 = __importDefault(require("fluent-ffmpeg")); // Tool to convert/resize videos
